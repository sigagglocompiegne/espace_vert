...
|Zone boisée|POLYGONE|Ensemble d'arbres dense essentiellement d'ambiance naturel. Pour rappel, les arbres dans une zones boisées situées dans un site cohérent (parc ...) doivent être saisies individuellement sur un espace délimité (enherbé, massif arbustif ...).|boisement d'ambiance naturel||

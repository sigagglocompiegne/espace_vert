...
**Dans un site cohérent (parc, square, coulée verte urbaine, ...), peuvent être associés aux espaces végétaux, des espaces minéraux (allée, aire de jeux ...) ou hydrographiques (bassin ...). En dehors, seuls les objets spécifiques aux espaces verts sont saisis.**

...
Schéma n°2 : Présentation du principe de modélisation des interactions entres les objets surfaciques et linéaires
...
|Alignement d'arbres (1)|LINEAIRE|Bande arborée, composée d'une série continue d'arbres entretenus (au moins 5), le long d'un axe routier ou piéton. Le linéaire saisi correspond au centre de l'emprise de l'alignement. Les ruptures de voirie devront être respectées. Chaque alignement doit être identifié.|arbre|![picto](regle_lineaire_v2.png)|

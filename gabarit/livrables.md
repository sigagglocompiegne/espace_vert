...
|Loisirs isolé|POINT|Tout équipement de loisirs indépendant d'un espace de loisirs intégré, identifiable dans un site cohérent (parc, square ...). L'objet restitué doit correspondre au centre de celui-ci.|jeux, élément de parcours sportif, table de pique-nique ...||

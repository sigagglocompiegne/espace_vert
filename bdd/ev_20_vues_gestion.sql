...
CREATE OR REPLACE VIEW m_espace_vert.geo_v_ev_point
 ...
 SELECT
	...
	p.geom
 FROM
 m_espace_vert.an_objet_ev o JOIN m_espace_vert.geo_ev_point p ON o.idobjet = p.idobjet;
...
CREATE OR REPLACE VIEW m_espace_vert.geo_v_ev_line
 ...
 SELECT
	...
	l.geom
 FROM
 m_espace_vert.an_objet_ev o JOIN m_espace_vert.geo_ev_line l ON o.idobjet = l.idobjet;
...
CREATE OR REPLACE VIEW m_espace_vert.geo_v_ev_polygon
 ...
 SELECT
	...
	p.geom
 FROM
 m_espace_vert.an_objet_ev o JOIN m_espace_vert.geo_ev_polygon p ON o.idobjet = p.idobjet;
 
 


-- FUNCTION: m_espace_vert.ft_m_insert_ev_point()

-- DROP FUNCTION m_espace_vert.ft_m_insert_ev_point();
-- FUNCTION: m_espace_vert.ft_m_insert_ev_point()

-- DROP FUNCTION m_espace_vert.ft_m_insert_ev_point();

CREATE OR REPLACE FUNCTION m_espace_vert.ft_m_insert_update_ev_point()
    RETURNS trigger
    LANGUAGE 'plpgsql'
    COST 100
...
-- Trigger: t_t1_insert_update_ev_point

-- DROP TRIGGER IF EXISTS t_t1_insert_update_ev_point ON m_espace_vert.geo_v_ev_point;
...
CREATE OR REPLACE FUNCTION m_espace_vert.ft_m_insert_update_ev_polygon()
    RETURNS trigger
    LANGUAGE 'plpgsql'
    COST 100
    VOLATILE NOT LEAKPROOF
...
-- Trigger: t_t1_insert_update_delete_ev_polygon

--DROP TRIGGER IF EXISTS t_t1_insert_update_delete_ev_polygon ON m_espace_vert.geo_v_ev_polygon;
...
CREATE OR REPLACE FUNCTION m_espace_vert.ft_m_insert_update_ev_line()
    RETURNS trigger
    LANGUAGE 'plpgsql'
    COST 100
    VOLATILE NOT LEAKPROOF
...
-- Trigger: t_t1_insert_update_delete_ev_line

--DROP TRIGGER IF EXISTS t_t1_insert_update_delete_ev_polygon ON m_espace_vert.geo_v_ev_line;
